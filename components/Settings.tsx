                          ...
                          <div key={level.id} className="flex items-center gap-4 p-4 rounded-lg border border-slate-100 bg-slate-50">
                             ...
                             <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                   ...
                                   <input 
                                      type="text" 
                                      className="w-full px-3 py-1.5 border border-slate-300 rounded bg-white focus:outline-none focus:border-indigo-500 text-sm"
                                      value={level.label}
                      ...
                      <div className="p-4 bg-slate-50 rounded-lg border border-slate-100">
                         ...
                         <div className="space-y-3">
                            <div>
                               ...
                               <input 
                                  type="text" 
                                  className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none text-sm bg-white"
